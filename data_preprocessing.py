...
train_data_file = open('C:/Users/mitta_ck4oqhq/Downloads/PRO-C140-Project-BoilerPlate-main/PRO-C140-Project-BoilerPlate-main/static/assets/chatbot_corpus/intents.json').read()
